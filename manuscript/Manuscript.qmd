...
You can add [@Varga2015] references either by referring to their id in the .bib file e.g., [@Marinkovi2020], or by switching to the visual editor (Cogwheel in the .Rmd menu -\> Use Visual Editor).
...
Number of syn: `r n_syn_PRC_IN1`  - cool!
